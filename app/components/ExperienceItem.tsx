...
export function ExperienceItem({
  ...
  return (
    <div className="group">
      ...
      <div
        className={`relative max-w-xl text-sm leading-relaxed text-gray-500 dark:text-gray-400 transition-all duration-300 ${!isExpanded && collapsible ? `${collapsedHeight} overflow-hidden` : ""}`}
      >
        {children}
