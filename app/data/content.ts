export const getMarkdownContent = (time: string) => `# Naveen Hiremath
/ • noun • ${time || "00:00:00"} IST
...
Connect with me on [LinkedIn](https://www.linkedin.com/in/naveen-hiremath-08b457257/) or shoot an [email](mailto:[access.naveenhiremath@gmail.com])

---

**Links:**
- GitHub: [https://github.com/PythonHacker24](https://github.com/C0deNe0)
- LinkedIn: [https://www.linkedin.com/in/aditya-patil-260a631b2/](https://www.linkedin.com/in/naveen-hiremath-08b457257/)
- Discord: [https://discord.gg/ry4YCJaShK](https://discord.gg/ry4YCJaShK)
- Calendar: [https://cal.com/adi-patil/30min](https://cal.com/naveen-hiremath/30min)
`;